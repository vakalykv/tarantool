...
test:do_test(
    ...
    function()
        ...
        -- <tkt2822-7.1>
        1, "Failed to execute SQL statement: 1st ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.1>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.2.1>
        1, "Failed to execute SQL statement: 2nd ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.2.1>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.3>
        1, "Failed to execute SQL statement: 3rd ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.3>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.4>
        1, "Failed to execute SQL statement: 4th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.4>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.9>
        1, "Failed to execute SQL statement: 9th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.9>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.10>
        1, "Failed to execute SQL statement: 10th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.10>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.11>
        1, "Failed to execute SQL statement: 11th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.11>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.12>
        1, "Failed to execute SQL statement: 12th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.12>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.13>
        1, "Failed to execute SQL statement: 13th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.13>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.20>
        1, "Failed to execute SQL statement: 20th ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.20>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.21>
        1, "Failed to execute SQL statement: 21st ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.21>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <tkt2822-7.22>
        1, "Failed to execute SQL statement: 22nd ORDER BY term out of range - should be between 1 and 25"
        -- </tkt2822-7.22>
    })
