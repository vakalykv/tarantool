...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <blob-1.4>
        1, [[Failed to execute SQL statement: unrecognized token: "X'01020k304'"]]
        -- </blob-1.4>
    })
...
test:do_catchsql_test(
    ...
    [[
        SELECT X'01020, 100]], {
        -- <blob-1.5>
        1, [[Failed to execute SQL statement: unrecognized token: "X'01020, 100"]]
        -- </blob-1.5>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <blob-1.7>
        1, [[Failed to execute SQL statement: unrecognized token: "X'01001'"]]
        -- </blob-1.7>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <blob-1.8>
        1, [[Failed to execute SQL statement: unrecognized token: "x'012/45'"]]
        -- </blob-1.8>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <blob-1.11>
        1, [[Failed to execute SQL statement: unrecognized token: "x'012G45'"]]
        -- </blob-1.11>
    })
