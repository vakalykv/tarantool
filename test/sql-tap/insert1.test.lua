...
test:do_test("insert-1.3", function()
  ...
  -- <insert-1.3>
  1, "Failed to execute SQL statement: table TEST1 has 3 columns but 2 values were supplied"
  -- </insert-1.3>
})
...
test:do_catchsql_test("insert-1.3b", [[
  ...
  -- <insert-1.3b>
  1, "Failed to execute SQL statement: table TEST1 has 3 columns but 4 values were supplied"
  -- </insert-1.3b>
})
...
test:do_catchsql_test("insert-1.3c", [[
  ...
  -- <insert-1.3c>
  1, "Failed to execute SQL statement: 4 values for 2 columns"
  -- </insert-1.3c>
})
...
test:do_catchsql_test("insert-1.3d", [[
  ...
  -- <insert-1.3d>
  1, "Failed to execute SQL statement: 1 values for 2 columns"
  -- </insert-1.3d>
})
...
test:do_catchsql_test("insert-1.4", [[
  ...
  -- <insert-1.4>
  1, "Failed to execute SQL statement: table TEST1 has no column named FOUR"
  -- </insert-1.4>
})
...
test:do_catchsql_test("insert-4.6", [[
  ...
  -- <insert-4.6>
  1, "Failed to execute SQL statement: no such function: NOTAFUNC"
  -- </insert-4.6>
})
...
-- if X(0, "X!capable", [["compound"]]) then
  ...
  test:do_catchsql_test("insert-10.2", [[
    ...
    -- <insert-10.2>
    1, "Failed to execute SQL statement: all VALUES must have the same number of terms"
    -- </insert-10.2>
  })
...
test:do_catchsql_test(
    ...
    {1, "Failed to execute SQL statement: table id list: duplicate column name A"})
...
test:do_catchsql_test(
    ...
    {1, "Failed to execute SQL statement: table id list: duplicate column name B"})
