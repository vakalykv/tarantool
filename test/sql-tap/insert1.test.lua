...
test:do_test("insert-1.3", function()
  ...
  -- <insert-1.3>
  1, "expected 3 columns for 'TEST1' but got 2"
  -- </insert-1.3>
})
...
test:do_catchsql_test("insert-1.3b", [[
  ...
  -- <insert-1.3b>
  1, "expected 3 columns for 'TEST1' but got 4"
  -- </insert-1.3b>
})
