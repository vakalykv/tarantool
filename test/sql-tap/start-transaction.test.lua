...
test:do_catchsql_test(
	...
	[[
		...
		-- <start-transaction-1.0>
		1, "Failed to execute SQL statement: near \"BEGIN\": syntax error"
		-- <start-transaction-1.0>
	})
...
test:do_catchsql_test(
	...
	[[
		...
		-- <start-transaction-1.6>
		1, "Failed to execute SQL statement: keyword \"TRANSACTION\" is reserved"
		-- <start-transaction-1.6>
	})
...
test:do_catchsql_test(
	...
	[[
		...
		-- <start-transaction-1.8>
		1, "Failed to execute SQL statement: keyword \"END\" is reserved"
		-- <start-transaction-1.8>
	})
