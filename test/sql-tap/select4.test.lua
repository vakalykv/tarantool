...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <select4-1.4>
        1, "Failed to execute SQL statement: ORDER BY clause should come after UNION not before"
        -- </select4-1.4>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <select4-4.3>
        1, "Failed to execute SQL statement: ORDER BY clause should come after INTERSECT not before"
        -- </select4-4.3>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <select4-5.1>
        1, "Failed to execute SQL statement: no such table: T2"
        -- </select4-5.1>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <select4-5.2h>
        1, "Failed to execute SQL statement: 1st ORDER BY term out of range - should be between 1 and 1"
        -- </select4-5.2h>
    })
